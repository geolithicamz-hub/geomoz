...
**Recursos:**
- Mapa geológico completo de Moçambique
- Cores geológicas padronizadas
- Features geográficas (relevo, oceanos, rios)
- Legendas personalizadas
- Seção geológica transversal

**Arquivos gerados:**
- `mozambique_geological_map.png`
- `mozambique_geological_cross_section.png`
...
**Recursos:**
- Coluna estratigráfica visual
- Escala temporal geológica
- Organização por idade (Archean → Cenozoic)
- Mapa estratigráfico integrado
- Análise de eras geológicas

**Arquivos gerados:**
- `mozambique_stratigraphic_column.png`
...
**Recursos:**
- Mapa de integração geologia-mineração
- Análise de correlação geologia-produção
- Mapa de potencial mineração
- Dashboard de mineração
- Estatísticas por unidade geológica

**Arquivos gerados:**
- `mozambique_mining_integration_map.png`
- `mozambique_mining_potential_map.png`
- `mozambique_mining_dashboard.png`
...
**Recursos:**
- Mapa geológico com relevo de terreno
- Zonas UTM de Moçambique
- Seções geológicas transversais
- Mapa de ocorrências minerais
- Projeções cartográficas profissionais

**Arquivos gerados:**
- `mozambique_geological_terrain_map.png`
- `mozambique_utm_zones_map.png`
- `mozambique_geological_cross_sections.png`
- `mozambique_mineral_occurrences_map.png`
...
- Índices de diversidade (Shannon, Simpson)
- Riqueza geológica

**Arquivos gerados:**
- `mozambique_geological_correlation_analysis.png`
- `mozambique_geological_diversity_index.png`
...
**Passos do Tutorial:**
1. **Uso Básico**: Como começar com GeoMoz
2. **Operações Espaciais**: Análise geográfica
3. **Exploração Mineral**: Aplicação prática
4. **Análise para Pesquisa**: Trabalhos acadêmicos

**Arquivos gerados:**
- `tutorial_step1_basic_map.png`
- `tutorial_step2_spatial_analysis.png`
- `tutorial_step3_mining_priority_map.png`
- `tutorial_step4_research_figures.png`
...
# Instalar dependências adicionais para exemplos
pip install cartopy matplotlib seaborn scipy
```

### Executar um Exemplo

```bash
# Navegar para a pasta de exemplos
cd examples

# Executar um exemplo específico
python 01_basic_geological_map.py
```

### Executar Tutorial Completo

```bash
# Executar tutorial passo a passo
python 06_complete_geologist_tutorial.py
```
...
- Dados reais de mineração devem ser integrados de fontes oficiais (INAMI, MIREME)
- CRS: WGS84 (EPSG:4326) para visualização, UTM para cálculos precisos
