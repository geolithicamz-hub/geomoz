...
def create_mining_integration_map():
    ...
    print("⛏️ Criando mapa de integração geologia-mineração...")
...
def create_mining_potential_map():
    ...
    print("\n🗺️ Criando mapa de potencial mineração...")
...
def main():
    """Função principal"""
    print("⛏️ Exemplo 03: Integração com Dados de Mineração")
    print("=" * 60)
